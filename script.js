...
const fixedTextureFolders = [
    ...
    { name: 'Stone', path: 'Textures/Roads/Stone', files: [
        'T1-Cobblestone-1.png','T1-Cobblestone-2.png','T1-Cobblestone-3.png','T1-Gravel-1.png','T1-Gravel-2.png','T1-Gravel-5.png','T1-Stone-1.png','T1-Stone-2.png','T1-Stone-3.png','T2-Cobblestone-1.png','T2-Cobblestone-2.png','T2-Gravel-1.png','T2-Gravel-2.png','T2-Stone-1.png','T2-Stone-2.png','T2-Stone-3.png','T2-Stone-5.png','T3-Cobblestone-1.png','T3-Cobblestone-2.png','T3-Gravel-1.png','T3-Stone-1.png','T3-Stone-2.png','T3-Stone-5.png','T4-Cobblestone-1.png','T4-Cobblestone-2.png','T4-Cobblestone-3.png','T4-Cobblestone-4.png','T4-Gravel-1.png','T4-Gravel-3.png','T4-Stone-1.png','T4-Stone-4.png','T4-Stone-5.png','T6-Cobblestone-1.png','T6-Gravel-1.png','T6-Gravel-3.png','T6-Gravel-5.png','T6-Stone-1.png','T6-Stone-1.png','T6-Stone-3.png','T6-Stone-5.png','T7-Gravel-1.png','T7-Gravel-2.png','T7-Gravel-3.png','T7-Gravel-4.png','T8-Gravel-1.png','T8-Gravel-3.png','T8-Gravel-5.png','T8-Stone-1.png','T8-Stone-3.png','T8-Stone-4.png','T8-Stone-5.png','T9-Gravel-1.png','T9-Gravel-2.png','T9-Gravel-3.png','T9-Gravel-4.png','T9-Gravel-5.png','T9-Stone-1.png','T9-Stone-3.png','T9-Stone-4.png'] },
